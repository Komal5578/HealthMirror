        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-8 border border-gray-200">
          <div className="relative">
            <input
              ...
              className="w-full text-center text-5xl font-medium bg-transparent text-gray-900 placeholder-gray-400 border-b-2 border-gray-300 pb-4 focus:outline-none focus:border-blue-600 transition-colors"
              min="10"
              max="120"
            />
